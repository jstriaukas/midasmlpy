...
class TestDataTransformation(unittest.TestCase):
    def setUp(self):
        ...
        output = datef.data_transform(Y, Y_date, X, X_date, x_lags=3, y_lags=0, horizon=0, legendre_degree=self.legendre_degree, standardize=True)
    ...
    def test_data_transform1(self):
        ...
        # Call the function
        output = sgl.best_model(x = self.x, y = self.y, group_size = self.legendre_degree, nlam = 50, pmax = 122, intr = False, k_folds = 2, disp_flag = False, alpha_values = 3, alpha = None)
