...
horizon <- 1
disp.flag <- FALSE
write.table(data.y, file = "input_data_y.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
write.table(data.ydate, file = "input_data_ydate.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
write.table(data.x, file = "input_data_x.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
write.table(data.xdate, file = "input_data_xdate.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
write.table(x.lag, file = "input_x_lag.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
write.table(y.lag, file = "input_y_lag.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
...
out <- mixed_freq_data(data.y, data.ydate, data.x, data.xdate, x.lag = 12, y.lag = 1, horizon = 1,
                       est.start, est.end, disp.flag = FALSE)

est.y <- out$est.y
est.ydate <- out$est.ydate
est.x = out$est.x
...
write.table(est.y, file = "output_est_y.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
write.table(est.ydate, file = "output_est_ydate.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
...
write.table(max.date, file = "output_max_date.txt", append = FALSE, sep = " ", dec = ".", row.names = FALSE, col.names = FALSE)
