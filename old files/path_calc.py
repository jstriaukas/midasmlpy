# -*- coding: utf-8 -*-
"""
Created on Mon Aug 17 12:19:08 2020
...
def sgl_fit(X, Z, y, index, lambdas, gamma_w=None, l1_factor=None, l21_factor=None,
  ...
  fit = np.zeros([21,3]).reshape(21,3)
...
print(path_calc(X, Z, y, index, gamma_w=None, l1_factor=0,
          l21_factor=0, dummies_index=1, nlam=None, min_frac=None))