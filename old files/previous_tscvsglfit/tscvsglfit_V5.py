...
def panelsglfitF(nf, nobs_nf, gamma, ngroups, gindex, nobs, nvars, x, y, pf, dfmax, pmax, nlam, flmin, ulam,
                eps, peps, isd, intr, maxit, nalam, bo, a0, beta, iteta, nbeta, alam, npass, jerr):
    jerr = jerr
    return True
# Updated
def sglfitpath(x, y, nlam, flmin, ulam, isd, intr, nf, eps, peps, dfmax, pmax, jd,
    ...
    if nf == 0:
        ...
        # sglfit(gamma, ngroups, gindex, nobs, nvars, x, y, pf, dfmax, pmax, nlam, flmin, ulam, eps, peps,
        #                isd, intr, maxit, nalam, b0, beta, ibeta, nbeta, alam, npass, jerr)
        # sglfit(gamma, ngroups, gindex, nobs, nvars, x, y, pf, dfmax, pmax, nlam, flmin, ulam, eps, peps,
        #                isd, intr, maxit, nalam, b0, beta, ibeta, nbeta, alam, npass, jerr)
        fit = sglfitF(gamma, ngroups, gindex, nobs, nvars, x, y, pf, dfmax, pmax, nlam, flmin, ulam, eps, peps,
                        isd, intr, maxit, nalam, b0, beta, ibeta, nbeta, alam, npass, jerr)
        nf = intr
    else:
        fit = panelsglfitF(nf, nobs/nf, gamma, ngroups, gindex, nobs, nvars, x, y, pf, dfmax, pmax, nlam, flmin, ulam,
